  ...
  return (
    <div className="container-fluid mt-5 profile-page">
      ...
      <div className="profile-details">
        ...
        <p><strong>First Name:</strong> <span className="profile-value">{user.firstname}</span></p>
        <p><strong>Last Name:</strong> <span className="profile-value">{user.lastname}</span></p>
      </div>
