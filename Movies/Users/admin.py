...
admin.site.register(TVShowRatingModel)
admin.site.register(FavoriteTVShowsModel)
admin.site.register(TVShowWatchlistModel)
admin.site.register(TVShowReviewModel)
admin.site.register(FeedbackModel)
admin.site.register(UserMovieHistoryModel)
admin.site.register(UserListModel)